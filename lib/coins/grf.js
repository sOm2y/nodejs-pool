...
function Coin(data){
    ...
    this.coinDevAddress = "G8FKF3iBiHDbXBhxC97zRJEr17mtQ4SjmWSQavKTQemHeDCtFQsJU8M4JN5BQoxnbpSquJaSpexVzEf1p3xui9QRRhLLKva";  // ArqTras
    this.poolDevAddress = "G8FKF3iBiHDbXBhxC97zRJEr17mtQ4SjmWSQavKTQemHeDCtFQsJU8M4JN5BQoxnbpSquJaSpexVzEf1p3xui9QRRhLLKva";  // ArqTras
    ...
    this.cryptoNight = function(convertedBlob) {
                return multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 8 ? convertedBlob[0] - 7 : 0);
